...
from curses_service_app.models import Task, Team, Course
from evaluation_service_app.models import Test, Question, Answer, TestResult, Option
from recommendations_service_app.models import Recommendation
from recommendations_service_app.views import notify
from evaluation_service_app.views import test_resolve
from curses_service_app.views import create_task
